...
exports.main = function(bot, msg, cooldown, botPerm, userPerm) { // Export command function
	...
	*/
	...
	console.log(`[${moment().format('DD/MM/YYYY HH:mm:ss')}][STATUS] ${bot.user.username}'s game set to '${msg.content.substr(config.commandPrefix.length + command.length + 2)}'! (${msg.author.username}#${msg.author.discriminator} on '${msg.guild}')`);
